<template>
  <div class="map-page-container" style="width:100%">
    ...
    <div class="block" style="z-index:200;margin-left:0.5%;;font-size:6px;background-color: aliceblue;">
            ...
            <div>
             <img src="@/assets/img/0.png" alt="" style="width:20px;height:20px;vertical-align: middle;"><span>:样区标记点</span>
            </div>
            <div>
             <img src="@/assets/img/1.png" alt="" style="width:20px;height:20px;vertical-align: middle;"><span>:区域撒播数据标记点</span>
            </div>
            <div>
             <img src="@/assets/img/2.png" alt="" style="width:20px;height:20px;vertical-align: middle;"><span>:蚁巢环施数据标记点</span>
            </div>
            <div>
             <img src="@/assets/img/qysb.jpg" alt="" style="width:20px;height:20px;vertical-align: middle;"><span>:区域撒播区域</span>
            </div>
            <div>
  ...
  <el-button style="margin-left:3%;" type="primary" @click="towxmap">查看卫星图层</el-button>
  </div>
  </div>
  <!-- 地图 -->
    <el-amap
...
//  监测点数组
 ...
 let bjfksarea:any[]=[]
  let bjyqsarea:any[]=[]
    ...
    // 进入卫星图层
    const towxmap=()=>{
    router.push({path:'/wmap/wfdatamap',query:{id,city}})
  }
